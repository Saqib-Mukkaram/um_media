...
class AppConstants {
  ...
  static const String rooster_forget_password_update =
      "/api/roster/password/update";
  static const String rental_category_list = "/api/rental/categories/types";
  static const String rental_category_by_type = "/api/rental/categories";
  static const String rental_category_items = "/api/rental/category/items";
